...
class KindSection(object):
    def __init__(self, basis_set, potential, structure=None):
        ...
        Args:
            basis_set (str): name of BASIS_SET in cp2k,
                             such as 'DZVP-MOLOPT-SR-GTH'
            potential (str): name of POTENTIAL in cp2k,
                             such as 'GTH-PBE'
    ...
    def __repr__(self):
        try:
            ...
            return (f'<KindSection: basis_set: {self.basis_set}, '
    ...
    def get_elements(self):
        if self.structure is not None:
            ...
            raise ValueError('Structure is not set, '
                             'please load structure first before get elements')
        return _elements


class DZVPPBE(KindSection):
    def __init__(self, basis_set='DZVP-MOLOPT-SR-GTH', potential='GTH-PBE',
                 structure=None):
